...
// Dummy arrays can stay for now since we don't have endpoints for them yet
      ...
      try {
        ...
        if (res.ok) {
          setUserDetails({
            ...
            followers: 0,
            following: 0,
            avatar: data.avatar || data.fullName.charAt(0).toUpperCase()
          });
        }
      } catch (error) {
                ...
                <div className="card-body p-4">
                  <div className="profile-header shadow-sm">
                    <div className="profile-avatar-wrapper">
                      <div className="rounded-circle text-orange d-flex align-items-center justify-content-center fw-bold profile-avatar bg-white border">
                        {userDetails?.avatar}
                      </div>
                    </div>
                  </div>
                  ...
                  {loading ? (
                    <div className="text-center mt-5 pt-3"><div className="spinner-border text-orange" role="status"></div></div>
                  ) : userDetails ? (
                    ...
                    <div className="text-center mt-5 pt-3">Failed to load profile.</div>
                  )}
                </div>
              </div>
