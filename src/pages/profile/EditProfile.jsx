                    ...
                    <div className="card-body p-4">
                      ...
                      <div className="row g-3">
                        <div className="col-md-6">
                          <label className="form-label small fw-semibold" htmlFor="firstName">First Name</label>
                          <input
                            type="text"
                        ...
                        <div className="col-md-6">
                          <label className="form-label small fw-semibold" htmlFor="lastName">Last Name</label>
                          <input
                            type="text"
                            className="form-control"
                            id="lastName"
